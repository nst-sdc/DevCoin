        ...
        <div className="w-full max-w-2xl mx-auto px-8 py-24 flex flex-col justify-center">
          ...
          <div className="mt-12 pt-8 border-t border-indigo-100">
            ...
            <div className="flex items-center space-x-6">
              <img src="https://images.unsplash.com/photo-1599305445671-ac291c95aaa9?w=200&h=50&fit=crop" alt="University Logo" className="h-8 w-auto grayscale opacity-50" />
              <img src="https://images.unsplash.com/photo-1599305445671-ac291c95aaa9?w=200&h=50&fit=crop" alt="College Logo" className="h-8 w-auto grayscale opacity-50" />
            </div>
          </div>
        </div>
      </div>
